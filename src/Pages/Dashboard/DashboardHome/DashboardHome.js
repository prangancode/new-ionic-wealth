  ...
  return (
    <>
      ...
      <div class="mb-12 border-b border-gray-200 dark:border-gray-700">
        <ul
          class="flex flex-wrap 2xl:w-3/4 2xl:mx-auto -mb-px text-sm font-medium text-center"
          id="myTab"
        ...
        >
          <li>
            <button
              className={
                toggleState === 1
                  ? "inline-block p-4 rounded-t-lg border-b-2  border-blue-600 dark:border-blue-500 active-tabs-dashboard-user"
        ...
        <div className="dashboard-content flex-grow ">
          <div className="lg:container m-0 lg:m-0 p-0 lg:p-0">
            ...
            <div
              className={
                toggleState === 2
                  ? "  active-content-services bg-white rounded-md py-4 lg:py-8 px-2 lg:px-4 xl:px-6"
                  : "content-services "
              }
            >
              <ContentCA />
